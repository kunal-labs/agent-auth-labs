...
"""CLI Tool to register a serverSideOauth2 Authorization resource in Discovery Engine."""
...
def register_oauth():
    print("--- [ Enterprise OAuth Registration for Gemini Enterprise ] ---")
    ...
    auth_id = get_config("AUTH_ID", "Enter Authorization ID (e.g. google-drive-auth)")
    ...
    # 1. Construct Authorization URI with mandatory access_type=offline and prompt=consent
    ...
    # 2. Prepare Discovery Engine API request
